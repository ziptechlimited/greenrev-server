...
exports.getPasswordResetTemplate = exports.getNewAcquisitionRequestTemplate = exports.getVerificationEmailTemplate = exports.getBaseEmailTemplate = void 0;
...
const getVerificationEmailTemplate = (verifyPin) => {
    const content = `
  ...
  `;
    return (0, exports.getBaseEmailTemplate)(content);
};
exports.getVerificationEmailTemplate = getVerificationEmailTemplate;
const getNewAcquisitionRequestTemplate = (customerName, productName) => {
    const content = `
...
exports.getNewAcquisitionRequestTemplate = getNewAcquisitionRequestTemplate;
